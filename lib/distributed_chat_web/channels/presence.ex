defmodule DistributedChatWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule DistributedChat.MyChannel do
        use DistributedChatWeb, :channel
        alias DistributedChatWeb.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :distributed_chat,
                        pubsub_server: DistributedChat.PubSub
end
